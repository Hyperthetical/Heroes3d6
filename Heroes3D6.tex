...
If a character suffers a successful \textlf{damage check} from a weapon with \textlf{crushing lethality}, or accumulates two \textlf{wounded} effects, they become \textlf{badly-wounded}. This results in \textlf{edge-} on all rolls until remedied in addition to the \textlf{wounded} effects.
...
This costs 1 reaction point and can be used when the character fails an \textlf{aim}, \textlf{deflect}, \textlf{resist}, or \textlf{power} check. This allows the character to re-roll the check, they must accept the result of this re-roll. This cannot be used if the character has any \textlf{edge} bonuses on the roll.
...
These enemies are followers, they need to be lead. Without a leader to direct them, they are likely to be easily demoralised by powerful opponents or to simply attack the enemy they feel is the most threatening. Such behaviour is over-ridden in the presence of a leader. Mundane enemies suffer the \textlf{panic} effect (see section~\ref{sec:special}) if they run out of \textlf{endurance} or suffer a wound effect. Enemies who believe in their cause, or are mindless, have immunity to this. When being lead, a mundane creature may add $1+$ its leader's \textlf{Resolve} score when making \textlf{panic} checks.
...
\subsubsection{Tactics}
Such enemies are independent, they do not need to be lead, but are more effective with a leader to direct them. These foes are unlikely to be easily demoralised or intimidated by powerful opposition and will coordinate and work together to defeat stronger opponents. Elites still suffer the \textlf{panic} effect (see section~\ref{sec:special}) if they run out of \textlf{endurance} or suffer a wound effect. Enemies who believe in their cause, or are \textlf{mindless}, have immunity to this. When being lead, an elite creature may add $1+$ its leader's \textlf{Resolve} score when making \textlf{panic} checks.
...
\textlf{Passive perk}. This allows the character to fight with two weapons for 1 action point instead of 2.
...
\textlf{Passive perk}. If the character succeeds on a \textlf{feint} action, then the next attack-action against the same target is a \textlf{sneak attack}.
