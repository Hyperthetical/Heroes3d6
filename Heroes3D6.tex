...
A character with 0 \textlf{endurance}, who suffers further damage increments their \textlfirst{wound level} by the attack's \textlf{lethality}. \textlf{wound levels} are \textlf{wounded}, \textlf{badly wounded}, \textlf{mortally wounded}, and \textlf{dead}.

\subsubsection{Critical hits}
If a character succeeds on a \textlf{damage check} by $\dicecritlvl$ or more, the attack's \textlf{lethality} is increased by 1 per $\dicecritlvl$ they exceeded it by.
...
\textlf{Passive perk}. If you make a \textlf{shove} action against a target you have \textlf{grappled} they are slammed to the ground. This causes a successful \textlf{shove} to deal damage with \textlf{lethality} 1 in addition to its usual effects. 
...
\begin{table}[ht!]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		\hline
		Creature & Might & Cunning & Wit & Resolve & Proficiencies \\
		\hline
		Canine & 0 & 0 & 0 & 1 & Survival \\
		Big cat & 0 & 1 & 0 & 0 & Stealth \\
		Bird & 0 & 0 & 1 & 0 & Awareness  \\
		Reptile & 1 & 0 & 0 & 0 & Stealth \\ 
		\hline
	\end{tabular}
\end{table}
...
\textlf{Passive perk}. You can spend a reaction point to re-roll a skill check if you \textlf{critically fail}. This can only be used once in a \textlf{multi-stage check}.
...
The character counts ranged weapons as having the \textlf{trip} rule.
...
The character counts ranged weapons as having the \textlf{disarm} rule.
